...
import { User, Mail, Lock, Loader, Rocket } from 'lucide-react';
    ...
    return (
        <div className="flex justify-center items-center min-h-[80vh] relative">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-1/3 left-1/4 w-64 h-64 bg-green-500/5 rounded-full blur-[100px]" />
                <div className="absolute bottom-1/3 right-1/4 w-64 h-64 bg-primary/5 rounded-full blur-[100px]" />
            </div>
            ...
            <div className="relative w-full max-w-md px-4">
                <div className="bg-card/80 backdrop-blur-xl border border-border/30 p-8 rounded-2xl shadow-2xl shadow-black/20">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-sm text-muted-foreground mt-1">Start your placement journey today</p>
                    </div>
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center">
                            <span className="bg-card/80 px-3 text-xs text-muted-foreground">or register with email</span>
                        </div>
                    </div>
